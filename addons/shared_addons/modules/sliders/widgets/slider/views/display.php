<?php if(count($images) != 0): ?>
	<link type="text/css" rel="stylesheet" href="addons/shared_addons/modules/sliders/css/nivo-slider.css">
	<link type="text/css" rel="stylesheet" href="addons/shared_addons/modules/sliders/css/nivo-slider.theme.css">
	<script type="text/javascript" src="addons/shared_addons/modules/sliders/js/jquery.nivo.slider.pack.js"></script>
