...
/**
 * Commentmovies module
 *
 * @author  PyroCMS Dev Team
 * @package PyroCMS\Core\Modules\Commentmovies
 */
class Module_Commentmovies extends Module
{
	...
	public function info()
	{
		return array(
			...
			'description' => array(
				'en' => 'Users and guests can write commentmovies for content like blog, pages and photos.',
				...
				'fr' => 'Les utilisateurs et les invités peuvent écrire des commentmovieaires pour quasiment tout grâce au générateur de captcha intégré.',
				...
				'it' => 'Utenti e visitatori possono scrivere commentmoviei ai contenuti quali blog, pagine e foto.',
	...
	{
		$this->dbforge->drop_table('commentmovies');
		$this->dbforge->drop_table('commentmovie_blacklists');
		...
		$settings = array(
			...
			array(
				'slug' => 'enable_commentmovies',
				'title' => 'Enable Commentmovies',
				'description' => 'Enable commentmovies.',
				'type' => 'radio',
				'default' => true,
				'value' => true,
				...
				'is_required' => 1,
				'is_gui' => 1,
				'module' => 'commentmovies',
				'order' => 968,
			),
			array(
				'slug' => 'moderate_commentmovies',
				'title' => 'Moderate Commentmovies',
				'description' => 'Force commentmovies to be approved before they appear on the site.',
				'type' => 'radio',
				'default' => true,
				'value' => true,
				'options' => '1=Enabled|0=Disabled',
			...
			array(
				'slug' => 'commentmovie_order',
				'title' => 'Commentmovie Order',
				'description' => 'Sort order in which to display commentmovies.',
				'type' => 'select',
				'default' => 'ASC',
				'value' => 'ASC',
			...
			array(
				'slug' => 'commentmovie_markdown',
				'title' => 'Allow Markdown',
				'description' => 'Do you want to allow visitors to post commentmovies using Markdown?',
				'type' => 'select',
				'default' => '0',
				'value' => '0',
