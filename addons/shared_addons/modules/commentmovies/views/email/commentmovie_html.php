<table width="100%" style="font:Tahoma, Arial, Helvetica, sans-serif; font-size:16px;">
	<tr>
		<td colspan="3"><h3>You have received a commentmovie from {<?php echo config_item('tags_trigger') ?>:name}</h3></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="3">
			<hr />
			{<?php echo config_item('tags_trigger') ?>:commentmovie}
			<br />
		</td>
  </tr>
	<tr>
		<td colspan="3">
			View Commentmovie:&nbsp;{<?php echo config_item('tags_trigger') ?>:redirect_url}
		</td>
	</tr>
</table>