					<? //print_r($posts); die():?><h2 class="page-heading">Movieslider Post</h2>
{{ if posts }}
	...
	{{ posts }}                    
                    ...
                    <article class="post post--news">
                        ...
                        <p class="post__date">{{ helper:lang line="movieslider:posted_label" }} {{ helper:date timestamp=created_on }}</p>
                        ...
                        <div class="tags">
                                <ul>
								{{ keywords }}
                                    <li class="item-wrap"><a href="{{ url:site }}movieslider/tagged/{{ keyword }}" class="tags__item">{{ keyword }}</a></li>
                                {{ /keywords }}   
                                </ul>
                        </div>
						{{ endif }}
