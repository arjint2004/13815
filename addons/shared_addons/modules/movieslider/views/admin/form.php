...
<?php if ($this->method == 'create'): ?>
	<h4><?php echo lang('movieslider:create_title') ?></h4>
<?php else: ?>
	<h4><?php echo sprintf(lang('movieslider:edit_title'), $post->title) ?></h4>
<?php endif ?>
</section>
...
<div class="tabs">
	...
	<ul class="tab-menu">
		<li><a href="#movieslider-content-tab"><span><?php echo lang('movieslider:content_label') ?></span></a></li>
		<?php if ($stream_fields): ?><li><a href="#movieslider-custom-fields"><span><?php echo lang('global:custom_fields') ?></span></a></li><?php endif; ?>
		<li><a href="#movieslider-options-tab"><span><?php echo lang('movieslider:options_label') ?></span></a></li>
	</ul>

	<!-- Content tab -->
	<div class="form_inputs" id="movieslider-content-tab">
		<fieldset>
			<ul>
				<li>
				...
				<li>
					<label for="status"><?php echo lang('movieslider:status_label') ?></label>
					<div class="input"><?php echo form_dropdown('status', array('draft' => lang('movieslider:draft_label'), 'live' => lang('movieslider:live_label')), $post->status) ?></div>
				</li>
		
				<li class="editor">
					<label for="body"><?php echo lang('movieslider:content_label') ?> <span>*</span></label><br>
	...
	<div class="form_inputs" id="movieslider-custom-fields">
		<fieldset>
			<ul>
	...
	<!-- Options tab -->
	<div class="form_inputs" id="movieslider-options-tab">
		<fieldset>
			<ul>
	
				<li>
					<label for="category_id"><?php echo lang('movieslider:category_label') ?></label>
					<div class="input">
					<?php echo form_dropdown('category_id', array(lang('movieslider:no_category_select_label')) + $categories, @$post->category_id) ?>
						[ <?php echo anchor('admin/movieslider/categories/create', lang('movieslider:new_category_label'), 'target="_blank"') ?> ]
					</div>
				</li>
				...
				<li class="date-meta">
					<label><?php echo lang('movieslider:date_label') ?></label>
				...
				<?php else: ?>
					<li>
						<label for="comments_enabled"><?php echo lang('movieslider:comments_enabled_label');?></label>
						<div class="input">
