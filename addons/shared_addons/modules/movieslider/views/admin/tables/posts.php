	<table cellspacing="0">
		<thead>
			<tr>
				...
				<th><?php echo lang('movieslider:post_label') ?></th>
				<th class="collapse"><?php echo lang('movieslider:category_label') ?></th>
				<th class="collapse"><?php echo lang('movieslider:date_label') ?></th>
				<th class="collapse"><?php echo lang('movieslider:written_by_label') ?></th>
				<th><?php echo lang('movieslider:status_label') ?></th>
		...
		<tbody>
			<?php foreach ($movieslider as $post) : ?>
				<tr>
					...
					<?php else: ?>
						<?php echo lang('movieslider:author_unknown') ?>
					<?php endif ?>
					</td>
					<td><?php echo lang('movieslider:'.$post->status.'_label') ?></td>
					<td style="padding-top:10px;">
                        <?php if($post->status=='live') : ?>
							<a href="<?php echo site_url('movieslider/'.date('Y/m', $post->created_on).'/'.$post->slug) ?>" title="<?php echo lang('global:view')?>" class="button" target="_blank"><?php echo lang('global:view')?></a>
                        <?php else: ?>
