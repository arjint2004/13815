                    ...
                    <div class="banner">
                        <ul>
                            ...
                            <li data-transition="fade" data-slotamount="7" class="slide" data-slide='Rush.'>
                                <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/slides/first-slide.jpg">
...
Create trip film.'>
                                <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/bg-video.jpg">
...
Start doing.'>
                                <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/slides/next-slide.jpg">
            ...
            <div class="movie-best">
                 ...
                 <div class="col-sm-12 change--col">
                     <div class="movie-beta__item ">
                        <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-sample1.jpg">
                     ...
                     <div class="movie-beta__item second--item">
                         <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-sample2.jpg">
                         <span class="best-rate">5.0</span>
                     ...
                     <div class="movie-beta__item third--item">
                         <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-sample3.jpg">
                         <span class="best-rate">5.0</span>
                     ...
                     <div class="movie-beta__item hidden-xs">
                         <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-sample4.jpg">
                         <span class="best-rate">5.0</span>
                     ...
                     <div class="movie-beta__item hidden-xs hidden-sm">
                         <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-sample5.jpg">
                         <span class="best-rate">5.0</span>
                     ...
                     <div class="movie-beta__item hidden-xs hidden-sm">
                         <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-sample6.jpg">
                         <span class="best-rate">5.0</span>
                        ...
                        <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--left">
                                <div class="movie__images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                        <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-time8.jpg">
                                    </a>
                                </div>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--left">
                                <div class="movie__images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-time1.jpg">
                                    </a>
                                </div>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--right">
                                <div class="movie__images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-time9.jpg">
                                    </a>
                                </div>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--right">
                                <div class="movie__images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-time10.jpg">
                                    </a>
                                </div>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--left">
                                <div class="movie__images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-time11.jpg">
                                    </a>
                                </div>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--left">
                                <div class="movie__images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-time12.jpg">
                                    </a>
                                </div>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--right">
                                <div class="movie__images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-time13.jpg">
                                    </a>
                                </div>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--right">
                                <div class="movie__images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/movie/movie-time14.jpg">
                                    </a>
                                </div>
                    ...
                    <aside class="col-sm-4 col-md-3">
                        <div class="sitebar first-banner--left">
                            <div class="banner-wrap first-banner--left">
                                <img alt='banner' src="<?=base_url()?>addons/shared_addons/themes/movie/images/banners/sale.jpg">
                            </div>

                             <div class="banner-wrap">
                                <img alt='banner' src="<?=base_url()?>addons/shared_addons/themes/movie/images/banners/sport.jpg">
                            </div>

                             <div class="banner-wrap banner-wrap--last">
                                <img alt='banner' src="<?=base_url()?>addons/shared_addons/themes/movie/images/banners/boots.jpg">
                            </div>
                            ...
                            <div class="promo marginb-sm">
                              ...
                              <div class="promo__content">
                                  <ul>
                                      <li class="store-variant"><a href="#"><img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/apple-store.svg"></a></li>
                                      <li class="store-variant"><a href="#"><img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/google-play.svg"></a></li>
                                      <li class="store-variant"><a href="#"><img alt='' src="<?=base_url()?>addons/shared_addons/themes/movie/images/windows-store.svg"></a></li>
                                  </ul>
                              </div>
                          </div>
