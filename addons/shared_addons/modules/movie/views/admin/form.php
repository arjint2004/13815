...
<?php if ($this->method == 'create'): ?>
	<h4><?php echo lang('movie:create_title') ?></h4>
<?php else: ?>
	<h4><?php echo sprintf(lang('movie:edit_title'), $post->title) ?></h4>
<?php endif ?>
</section>
...
<div class="tabs">
	...
	<ul class="tab-menu">
		<li><a href="#movie-content-tab"><span><?php echo lang('movie:content_label') ?></span></a></li>
		<?php if ($stream_fields): ?><li><a href="#movie-custom-fields"><span><?php echo lang('global:custom_fields') ?></span></a></li><?php endif; ?>
		<li><a href="#movie-options-tab"><span><?php echo lang('movie:options_label') ?></span></a></li>
	</ul>

	<!-- Content tab -->
	<div class="form_inputs" id="movie-content-tab">
		<fieldset>
			<ul>
				<li>
				...
				<li>
					<label for="status"><?php echo lang('movie:status_label') ?></label>
					<div class="input"><?php echo form_dropdown('status', array('draft' => lang('movie:draft_label'), 'live' => lang('movie:live_label')), $post->status) ?></div>
				</li>
		
				<li class="editor">
					<label for="body"><?php echo lang('movie:content_label') ?> <span>*</span></label><br>
	...
	<div class="form_inputs" id="movie-custom-fields">
		<fieldset>
			<ul>
	...
	<!-- Options tab -->
	<div class="form_inputs" id="movie-options-tab">
		<fieldset>
			<ul>
	
				<li>
					<label for="category_id"><?php echo lang('movie:category_label') ?></label>
					<div class="input">
					<?php echo form_dropdown('category_id', array(lang('movie:no_category_select_label')) + $categories, @$post->category_id) ?>
						[ <?php echo anchor('admin/movie/categories/create', lang('movie:new_category_label'), 'target="_blank"') ?> ]
					</div>
				</li>
				...
				<li class="date-meta">
					<label><?php echo lang('movie:date_label') ?></label>
